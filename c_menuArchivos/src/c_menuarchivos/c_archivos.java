package c_menuarchivos;

import java.awt.Color;
import java.io.*;
import javax.swing.*;

public class c_archivos extends javax.swing.JFrame {
    File archivo;
    public c_archivos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        menbBarras.setForeground(new java.awt.Color(0, 0, 0));
        ...
        menuEdicion.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        menuAbout.setFont(new java.awt.Font("Arial Narrow", 0, 12)); // NOI18N
        ...
        menuAbout.add(meniCreador);

        menbBarras.add(menuAbout);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(c_archivos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new c_archivos().setVisible(true);
            }
        });
    }
